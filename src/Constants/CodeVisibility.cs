...
public static partial class Constants
{
    ...
    {
        private CodeVisibility(string value)
        {
            Value = value;
        }
        ...
        public static readonly CodeVisibility ProtectedInternal =
            new($"{nameof(Protected)} {nameof(Internal)}".ToLower());
        public static readonly CodeVisibility PrivateProtected =
            new($"{nameof(Private)} {nameof(Protected)}".ToLower());
