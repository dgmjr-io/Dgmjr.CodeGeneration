...
public static class Constants
{
    ...
    public const string CTCG001ErrorMessage = "Die zur Kompilierungszeit berechnete Konstante muss in einem statischen schreibgeschützten Feld definiert werden.  Habe stattdessen {0} gefunden.";
