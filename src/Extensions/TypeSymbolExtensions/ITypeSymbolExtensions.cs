...
public static partial class ITypeSymbolExtensions
{
    ...
    /// </returns>
    public static TypeParameterListSyntax ToTypeParameterListSyntax(
        ...
        switch (typeSymbol.TypeKind)
        {
            ...
            case TypeKind.Array:
                ...
                return SyntaxFactory
                    .ArrayType(arrayTypeSymbol.ElementType.ToTypeSyntax())
                    .WithRankSpecifiers(
            ...
            case TypeKind.Dynamic:
                throw new InvalidOperationException(
                    "Can't generate code for type kind " + typeSymbol.TypeKind
                );

            case TypeKind.Delegate:
                var delegateTypeSymbol = (INamedTypeSymbol)typeSymbol;
                throw new InvalidOperationException(
                    "Can't generate code for type kind " + delegateTypeSymbol.TypeKind
                );
    ...
    public static ClassDeclarationSyntax ToClassDeclarationSyntax(
        ...
        return SyntaxFactory.ClassDeclaration(
            ...
            baseList: SyntaxFactory.BaseList(
                SyntaxFactory.SeparatedList(
                    new[]
                    {
                        SyntaxFactory.SimpleBaseType(interfaceSymbol.ToTypeSyntax())
                            as BaseTypeSyntax
                    }
                )
            ),
            ...
            members: SyntaxFactory.List(
                interfaceSymbol
                    ...
                    .Select(
                        methodSymbol =>
                            methodSymbol.ToMethodDeclarationSyntax() as MemberDeclarationSyntax
                    )
            )
        );
    }
    ...
    public static CompilationUnitSyntax ToCompilationUnitSyntax(
        this INamedTypeSymbol interfaceSymbol
    )
    {
        return SyntaxFactory
